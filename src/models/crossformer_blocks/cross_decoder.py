...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, cross):
        ...
        #
        # print(f"CrossFormer Decoder Layer: {x.shape}, {cross.shape}")
        ...
        #print(f"CrossFormer Decoder Layer: {dec_output.shape}")
        
        layer_predict = self.linear_pred(dec_output)
        layer_predict = rearrange(layer_predict, 'b out_d seg_num seg_len -> b (out_d seg_num) seg_len')

        #print(f"CrossFormer Decoder Layer: {layer_predict.shape}")
...
class Decoder(nn.Module):
    ...
    def forward(self, x, cross):
        ...
        #print(f"CrossFormer Decoder: {x.shape}")
        ...
        for layer in self.decode_layers:
            ...
            #print(f"CrossFormer Decoder: {x.shape}, {layer_predict.shape}")
        ...
        #print(f"CrossFormer Decoder: {final_predict.shape}")
